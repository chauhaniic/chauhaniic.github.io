...
<tr>
  ...
  <td><input type="text" name="google_link" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_google_link',''))); ?>" /></td>
</tr>
<tr>
